  ...
  useIsoLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      t.set(".menu", { pointerEvents: "auto" })
        .fromTo(".menu", { clipPath: "inset(0% 0% 100% 0%)" }, { clipPath: "inset(0% 0% 0% 0%)", duration: reduced ? 0.001 : 0.62, ease: EASE.swap }, 0)
        .fromTo(".menu-item", { yPercent: 118 }, { yPercent: 0, duration: reduced ? 0.001 : 0.72, ease: EASE.enter, stagger: reduced ? 0 : 0.06 }, reduced ? 0 : 0.16)
        .fromTo(".menu-foot", { opacity: 0 }, { opacity: 1, duration: reduced ? 0.001 : 0.5 }, reduced ? 0 : 0.4)
